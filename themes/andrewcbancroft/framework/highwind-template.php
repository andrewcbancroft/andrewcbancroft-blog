...
if ( ! function_exists( 'highwind_post_meta_index' ) ) {
	function highwind_post_meta_index() {
		if ( ! is_page() ) {
			?>
			<aside class="post-meta">
				<ul>
				    <li><time class="post-date"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'highwind' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_time( get_option( 'date_format' ) ); ?></a></time></li>
					<?php the_tags( '<li class="tags">', ', ','</li>' ); ?>
					<!--<li class="comment"><?php comments_popup_link( __( '0 Comments', 'highwind' ), __( '1 Comment', 'highwind' ), __( '% Comments', 'highwind' ) ); ?></li>-->
				</ul>
			</aside><!-- /.post-meta -->
...
function highwind_credit() {
	?>
	<p>
		© Copyright <?php echo date("Y"); ?>, <a href="https://plus.google.com/u/0/110731696140120282470?rel=author">Andrew Bancroft</a>.
