...
<div class="resources">
  ...
  <ul class="resources-content">
    <li>
        <i class="fas fa-file-csv"></i> <a href="/datasets/Car%20Sales.csv" download>Car Sales.csv</a>
    </li>
    <li>
...
* Cells in this notebook expect the <a href="/datasets/Car%20Sales.csv">Car Sales.csv</a> file to be in the same directory as your notebook
