...
It's a fair question: Is [dimensional modeling](/blog/data/dimensional-modeling/what-is-a-dimensional-model/) still relevant in the age of big data?
...
In ["Stages to Machine Learning"](/blog/data/machine-learning/stages-to-machine-learning/), I discuss some always-required steps to getting from A to Z in machine learning endeavors.  Two of those:  data cleansing, and data transformation.
