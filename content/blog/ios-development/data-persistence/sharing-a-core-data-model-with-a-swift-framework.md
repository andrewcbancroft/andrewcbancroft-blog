...
<div class="resources">
  ...
  <ul class="resources-content">
    ...
    <li>
      <a href="#create-swift-framework-project">Creating a Swift framework project</a>
    </li>
    <ul>
      <li>
        <a href="#add-data-model-file">Add a data model file</a>
      </li>
      <li>
        <a href="#add-model-attributes">Add model attributes</a>
      </li>
      <li>
        <a href="#create-nsmanagedobject-subclass">Create NSManagedObject subclass</a>
      </li>
      <li>
        <a href="#build-inspect-outputs">Build and inspect outputs</a>
      </li>
    </ul>
    
    <li>
      <a href="#create-framework-dependent-app">Creating the framework-dependent app</a>
    </li>
    <ul>
      <li>
        <a href="#remove-xcode-generated-xcdatamodeld">Remove Xcode-generated .xcdatamodeld file</a>
      </li>
      <li>
        <a href="#obtain-framework-bundle-identifier">Obtain framework Bundle Identifier</a>
      </li>
      <li>
        <a href="#replace-managed-object-model-property">Replace managedObjectModel property initialization</a>
      </li>
      <li>
        <a href="#add-carkit-framework">Add CarKit framework to project and embed binary</a>
      </li>
      <li>
        <a href="#take-for-test-drive">Taking the model out for a test drive (pun intended)</a>
      </li>
    </ul>
